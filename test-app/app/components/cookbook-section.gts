...
export interface CookbookSectionSignature {
  ...
  Args: {
    ...
    id: string;
    title: string;
    /** Short “what / why” under the title */
    blurb?: string;
    /** Source recipe shown under the live demo */
    code: string;
    /**
     * Start with the recipe open (default true — the point of this page).
     */
    codeOpen?: boolean;
  };
  Blocks: {
...
/**
 * One cookbook entry: title, live demo (block), then “how to build” source.
 */
