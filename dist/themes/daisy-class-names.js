 ...
 */
const DAISY_CLASS_NAMES = {
  containerOuter: ['choices', 'w-full', 'relative', 'choices-ember--daisy'],
  containerInner: ['choices__inner', 'input', 'input-bordered', 'w-full', 'min-h-12', 'h-auto', 'flex', 'flex-wrap', 'items-center', 'gap-1', 'py-2'],
  input: ['choices__input'],
  inputCloned: ['choices__input--cloned', 'input', 'input-ghost', 'input-sm', 'grow', 'min-w-[6rem]', 'border-0', 'bg-transparent', 'focus:outline-none'],
  list: ['choices__list'],
  listItems: ['choices__list--multiple', 'flex', 'flex-wrap', 'gap-1'],
  listSingle: ['choices__list--single'],
  listDropdown: ['choices__list--dropdown', 'menu',
  // menu can shrink to content; keep panel as wide as the control
  'w-full', 'min-w-full', 'bg-base-100', 'rounded-box', 'shadow-lg', 'border', 'border-base-300', 'z-[100]', 'p-1', 'mt-1'],
  item: ['choices__item'],
  ...
  button: ['choices__button', 'btn', 'btn-ghost', 'btn-xs', 'min-h-0', 'h-5', 'w-5', 'p-0'],
...
export { DAISY_CLASS_NAMES };
//# sourceMappingURL=daisy-class-names.js.map
